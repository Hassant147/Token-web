...
const roadmapDataList = [
    ...
    },
    {
        ...
        stepTitle: [
            'Listing on DEXs',
            'Research & Development Fund Allocation',
        ...
        step: [
            ...
            },
            {
                ...
                list: [
                    ...
                    'Secure global exchange listings to increase token liquidity.',
                    'Establish market-making partnerships to ensure stable trading.',
                ]
            },
            {
    ...
    },
    {
        ...
        stepTitle: [
            ...
            'Worldwide AI Toreda Card Adoption Champaign',
            'Listing on Binance',
            'Global Agreements',
        ],
        step: [
    ...
    },
    {
        ...
        dept: 'AITO Staking',
        stepTitle: [
            'Beta Version of payment Gateways',
            'Token Integration',
            'AITO Staking launch date',
        ],
        step: [
            {
    ...
    },
    {
        ...
        step: [
            ...
            },
            {
                ...
                list: [
                    'Launch of Product web platform for users',
                    'Global social and organic marketing campaigns.',
                ]
            },
            {
                title: 'AI Toreda App Prototyping and Development',
                list: [
                    'Build prototype and design mockups;',
                    'Initiate App development for Android and IOS users.;',
                ]
            }
        ]
    },
                                ...
                                <div className="col-lg-6">
                                    <div className='hmrbannerCnt roadmapBannerCnt'>
                                        ...
                                        <p className='bannerPara'>
                                            AITO roadmap lays out a strategic path for AI Toreda’s growth and development, emphasizing key milestones and objectives to drive success in the blockchain and AI space.
                                        </p>
