            ...
            <div className="bgPrimarbx py-lg-5 pt-5 pb-0 mb100px position-relative zindex0">
                <div className="container">
                    <div className='bannerContent my-lg-5 mb-0'>
                        <div className='row align-items-center'>
                            <div className="col-lg-7">
                                <div className='hmrbannerCnt processingBannercnt'>
                                    ...
                                    Unlock your full potential with our revolutionary Career Development App, powered by AI TOREDA Crypto Token. Our platform is designed to identify and bridge skill gaps, offering personalized development pathways tailored to your unique career goals.
                                    </p>
                        ...
                        <div className='bannerCareerApp outerimg d-none d-lg-block'>
                             <img src={careerdevelopementBanner} alt='careerdevelopementBanner' className='img-fluid' />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-7 order-1 order-lg-2">
                            <div className='sec-cnt'>
                                ...
                                <div className='para'>Our Personal and Career Development Tools are cutting-edge solutions designed to identify and fulfill the unique needs of individuals seeking to advance their careers. Utilizing a proprietary AI model, our platform accurately pinpoints skills gaps and provides tailored development pathways, ensuring effective and personalized growth for each user.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-9 sec-cnt">
                            ...
                            <div className='para text-center mb-5'>Our tools empower users to achieve their career goals with confidence, setting a new benchmark for personal and professional development in the industry.</div>
                        </div>
                    </div>
                    <div className="row">
