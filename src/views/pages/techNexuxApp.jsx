                            ...
                            <div className="col-xl-6">
                                <div className='hmrbannerCnt mt-xl-5 processingBannercnt'>
                                    ...
                                    <p className='bannerPara mb-5'>
                                        Tech Nexus stands at the forefront of innovation, offering an unparalleled tech hub incubator designed to propel startups and emerging tech businesses to new heights. Our mission is to be the catalyst for the next wave of tech entrepreneurship, providing comprehensive support that includes funding, technological expertise, and strategic growth opportunities to ensure rapid and sustainable success.
                                    </p>
                                    <div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-7 order-1 order-lg-2">
                            <div className='sec-cnt'>
                                ...
                                <div className='para'>Tech Nexus is not just an incubator—it is a transformative platform that bridges the gap between visionary ideas and tangible success. By integrating comprehensive financial support, cutting-edge technological development, and strategic business expansion services with a pioneering digital currency, Tech Nexus is set to redefine the startup landscape and foster a dynamic, interconnected ecosystem of thriving businesses.</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-9 sec-cnt">
                            ...
                            <div className='para text-center mb-5'>
                                Tech Nexus will lead the way in integrating a proprietary digital currency, <b>AiToreda (AITO)</b>, within our ecosystem. Nexus-Coin will revolutionize transactions among member businesses, providing a unified, secure, and efficient medium of exchange. Key features include:
                            </div>
                        </div>
                    </div>
