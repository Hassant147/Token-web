                                ...
                                <div className="col-lg-6">
                                    <div className='hmrbannerCnt mt-lg-5'>
                                        ...
                                        <div className='btnFlex mb-5'>
                                            <button className={`btn btn-secondary btn-w186 btn-h69 fs-24 fw-400 ${selectedTag === 'Blog' ? 'active' : ''}`} onClick={() => setSelectedTag('Blog')}>Blog</button>
                                            <button className={`btn btn-secondary btn-w186 btn-h69 fs-24 fw-400 ${selectedTag === 'News' ? 'active' : ''}`} onClick={() => setSelectedTag('News')}>News</button>
                                            <button className={`btn btn-secondary btn-w186 btn-h69 fs-24 fw-400 ${selectedTag === 'All' ? 'active' : ''}`} onClick={() => setSelectedTag('All')}>All</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                        ...
                        <div className='row'>
                            <div className="col-12">
                                        ...
                                        <div className="d-flex flex-column flex-md-row">
                                            ...
                                            <div>
                                                ...
                                                <div className='d-flex justify-content-md-between flex-column flex-md-row'>
                                                    ...
                                                    <Link to={item.url} className='np-readpost'>Read full post &#8594;</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="text-center d-flex align-items-center justify-content-center mb-5">
                                    ...
                                    <span className='px-1 fs-20 fw-400'>{currentPage} of {Math.ceil(filteredPosts.length / postsPerPage)}</span>
