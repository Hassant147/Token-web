...
const faqdataList = [
    ...
    },
    {
        ...
        ans: ['AITOREDA stands out by its unique TRD-based architecture, which prioritizes trust and security. Unlike many other cryptocurrencies that rely on complex algorithms and energy-intensive mining, AITOREDA offers a simpler and more sustainable approach.']
    },
    {
        qus: 'How does AITOREDA work?',
        ans: ['AITOREDA operates on a decentralized network where transactions are verified and validated through a network of Trust Relationship Domains (TRDs). These TRDs establish trust between users, ensuring the integrity of the system.']
    },
    {
        qus: 'What is the role of Trust Relationship Domains (TRDs) in AITOREDA?',
        ans: [`TRDs serve as the foundation of AITOREDA's security and trust system. They represent relationships between users and contribute to the overall reliability of the network.`]
    },
    {
        qus: 'How can I use AITOREDA for transactions?',
        ans: ['AITOREDA can be used for various transactions, including peer-to-peer payments, online purchases, and remittances. You can store your AITOREDA in a secure digital wallet and easily transfer funds to other users.']
    },
    {
    ...
    return (
        <>
            <div className='mainContent'>
                            ...
                            <div className='row'>
                                ...
                                <div className="col-lg-6">
                                    <div className='hmrbannerCnt'>
                                        ...
                                        <h1 className='bannerTit'>Combining <br className='d-none d-lg-block' />
                                            Artificial&nbsp;Intelligence <br className='d-none d-lg-block' />
                                            with <span className='text-primary'>Blockchain</span></h1>
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-8">
                                    <div>
                                        ...
                                        <p className='paraTxt'>Ai-Toreda is a groundbreaking project dedicated to merging artificial intelligence with blockchain technology to offer innovative solutions across various sectors. Our platform aims to enhance efficiency, security, and innovation through our unique AI-driven approach. By leveraging the power of AI, we are creating a robust ecosystem that addresses real-world challenges and opens up new opportunities for growth and development."</p>
                                    </div>
                                </div>
                                            ...
                                            <TabContent activeTab={activeTab}>
                                                ...
                                                <TabPane tabId="tech">
                                                    <div className="tabcnt">
                                                        <p>The Al Toreda Token is built upon a robust, future-ready technological foundation designed to ensure seamless integration, rapid development, and exceptional scalability. Our strategic adoption of the MERN stack underscores our unwavering commitment to creating a token ecosystem that not only meets but exceeds the expectations of our users and stakeholders.</p>
                                                    ...
                                                    <div className="tabcnt">
                                                        <div className="row">
                                                            <div className="col-lg-7">
                                                                ...
                                                                <div className='chatLegent'>
                                                                    <div className='chatlabel'>
                                                                        <img src={require('../../../assets/images/arrow-right.svg').default} alt='arrow-right' /> Liquidity </div>
                                                                    <div className='chatRightLabel'>
                                                                        <div className='chatpercent'>
                                                                            35%</div>
                                                                ...
                                                                <div className='chatLegent'>
                                                                    <div className='chatlabel'>
                                                                        <img src={require('../../../assets/images/arrow-right.svg').default} alt='arrow-right' /> Marketing </div>
                                                                    <div className='chatRightLabel'>
                                                                        <div className='chatpercent'>
                                                                            5%</div>
                                                                ...
                                                                <div className='chatLegent'>
                                                                    <div className='chatlabel'>
                                                                        <img src={require('../../../assets/images/arrow-right.svg').default} alt='arrow-right' /> Exchange Listings </div>
                                                                    <div className='chatRightLabel'>
                                                                        <div className='chatpercent'>
                                                                            8%</div>
                                                                        <div className='chatval'>100,000,000</div>
                                                                ...
                                                                <div className='chatLegent'>
                                                                    <div className='chatlabel'>
                                                                        <img src={require('../../../assets/images/arrow-right.svg').default} alt='arrow-right' /> Burned  </div>
                                                                    <div className='chatRightLabel'>
                                                                        <div className='chatpercent'>
                                                                            10%</div>
                                                                        <div className='chatval'>100,000,000</div>
                                                                ...
                                                                <div className='chatLegent'>
                                                                    <div className='chatlabel'>
                                                                        <img src={require('../../../assets/images/arrow-right.svg').default} alt='arrow-right' /> Development  </div>
                                                                    <div className='chatRightLabel'>
                                                                        <div className='chatpercent'>
                                                                            15%</div>
                                                                        <div className='chatval'>100,000,000</div>
                                                                ...
                                                                <div className='chatLegent'>
                                                                    <div className='chatlabel'>
                                                                        <img src={require('../../../assets/images/arrow-right.svg').default} alt='arrow-right' /> Team </div>
                                                                    <div className='chatRightLabel'>
                                                                        <div className='chatpercent'>
                                                                            2%</div>
                                                                        <div className='chatval'>100,000,000</div>
                            ...
                            <div className="col-lg-7">
                                <div className="dc-card-sec mb-4 mb-lg-0">
                                    ...
                                    <div className="paraTxt">
                                        <p>Step into a realm where your digital assets redefine convenience and unlock a world of exclusive perks. With the AITO Debit Card and AIToreda, your everyday transactions are transformed into rewarding experiences.</p>
                                        <div className="text-right d-lg-none cryptodepositInnerImg mb-4">
                                            <img src={cryptoDepitcardImg} alt='cryptoDepitcardImg' className='img-fluid' />
                                        </div>
                                        <p>Our AITO Debit Card is your gateway to a curated selection of special offers, tailored just for you. Through strategic partnerships with top merchants globally, AIToreda ensures that you receive unmatched value every time you use your card.</p>
                                        <p>Embrace a new way of spending where each transaction with your AITO Debit Card not only simplifies your life but also grants you access to exclusive benefits that elevate your lifestyle. Become a part of the AIToreda community today and turn every purchase into an opportunity to enhance your world.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 offset-lg-1">
                                {/* <div className="text-right d-lg-none cryptodepositInnerImg mb-n5">
                                    <img src={cryptoDepitcardImg} alt='cryptoDepitcardImg' className='img-fluid' />
                                </div> */}
                            </div>
                        </div>
                ...
                <section className=' sliderSection' style={{ width: '85%', margin: '100px auto', padding: '10px' }}>
                    <div className='container'>
                        <div className='row no-gutters'>
                            <div className='col-xl-12'>
                                <div className='d-flex flex-column flex-md-row align-items-md-center mb-4'>
                                    ...
                                    <div className='sliderprevnextBtn ml-3 text-right text-md-left'>
                                        <button className="btn btnEmpty sliderArrowIcon" onClick={previousSlider}>
                                            <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.500002 19C0.500003 8.78273 8.78274 0.499997 19 0.499998C29.2173 0.499999 37.5 8.78273 37.5 19C37.5 29.2173 29.2173 37.5 19 37.5C8.78273 37.5 0.500001 29.2173 0.500002 19Z" fill="white" stroke="#9649FD" />
                                                <path d="M10.7576 18.6464C10.5623 18.8417 10.5623 19.1583 10.7576 19.3536L13.9395 22.5355C14.1348 22.7308 14.4514 22.7308 14.6466 22.5355C14.8419 22.3403 14.8419 22.0237 14.6466 21.8284L11.8182 19L14.6466 16.1716C14.8419 15.9763 14.8419 15.6597 14.6466 15.4645C14.4514 15.2692 14.1348 15.2692 13.9395 15.4645L10.7576 18.6464ZM28 18.5L11.1111 18.5L11.1111 19.5L28 19.5L28 18.5Z" fill="#9649FD" />
                                            </svg>
                                        </button>
                                        <button className="btn btnEmpty sliderArrowIcon" onClick={nextSlider}>
                                            <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M37.5 19C37.5 29.2173 29.2173 37.5 19 37.5C8.78273 37.5 0.5 29.2173 0.5 19C0.5 8.78273 8.78273 0.5 19 0.5C29.2173 0.5 37.5 8.78273 37.5 19Z" fill="white" stroke="#9649FD" />
                                                <path d="M28.2424 19.3536C28.4377 19.1583 28.4377 18.8417 28.2424 18.6464L25.0605 15.4645C24.8652 15.2692 24.5486 15.2692 24.3534 15.4645C24.1581 15.6597 24.1581 15.9763 24.3534 16.1716L27.1818 19L24.3534 21.8284C24.1581 22.0237 24.1581 22.3403 24.3534 22.5355C24.5486 22.7308 24.8652 22.7308 25.0605 22.5355L28.2424 19.3536ZM11 19.5H27.8889V18.5H11V19.5Z" fill="#9649FD" />
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        {SliderDataList.map((item, index) => (
                                            <div className='sliderBx' key={index}>
                                                <div>
                                                    ...
                                                    <div className="paraTxt">
                                                        {item.paraList.map((paratxt, paraIndex) => (
                                                            <p key={paraIndex}>{paratxt}</p>
                                                        ))}
                                                    </div>
                                                </div>
                                                <div className='text-right'>
                                                    <Link to={item.url}>
                                                        <button className='btn btnReadMore'>Read more about this app &#8594; </button>
                                                    </Link>
                                                </div>
                                            </div>
                                        ))}
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 text-lg-right">
                                <Link to={'/faq'} className='btn btn-outline-primary round15 fs-24 h-auto py-2'>Frequently Asked Questions</Link>
                            </div>
                        </div>
                    </div>
                </section>
