                    ...
                    <div className='container'>
                        ...
                        <div isOpen={isOpen} navbar className={`menucollapse ${isOpen ? 'show' : ''}`}>
                            <Nav className="ml-auto" navbar>
                                <NavItem>
                                    <Link className='nav-link' to="/roadmap"><span>Roadmap</span></Link>
                                </NavItem>
                                <NavItem>
                                    <UncontrolledDropdown className="position-relative d-inline-block">
                                        <DropdownToggle tag='a' className="btn btn-Icon nav-link">
                                            <span>Products <img src={require('../../assets/images/arrowdown.svg').default} alt='arrowdown.svg' /></span>
                                        </DropdownToggle>
                                        <DropdownMenu right className="custom-dropdownmenu">
                                            <ul id="usermenu" className="" role="menu">
                                                <li role="menuitem">
                                                    <Link className="dropdown-item" to="/tech-nexus-app">Tech nexus</Link>
                                                </li>
                                                <li role="menuitem">
                                                    <Link className="dropdown-item" to="/visa-processing-app">Visa processing app</Link>
                                                </li>
                                                <li role="menuitem">
                                                    <Link className="dropdown-item" to="/career-development-app">Career development app</Link>
                                                </li>
                                                <li role="menuitem">
                                                    <Link className="dropdown-item" to="/decentralised-trade">Decentralised Trade</Link>
                                                </li>
                                            </ul>
                                        </DropdownMenu>
                                    </UncontrolledDropdown>
                                ...
                                <NavItem>
                                    <Link className='nav-link' to="/blog"><span>News</span></Link>
                                </NavItem>
                            </Nav>
                            <NavbarText>
                                <Link to="/" class="btn button-primary buttonheader" role="button"> <span class="px-0">Buy</span></Link>
                            </NavbarText>
